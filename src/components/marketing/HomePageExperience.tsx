...
const pricingCards = [
  {
    name: "Signal Room",
    price: "KES 2,600",
    meta: "Kenya launch stack",
    detail: "Paystack, M-PESA, WhatsApp, local SMS, light voice",
    href: "/auth/signup?plan=starter",
    featured: false,
    lines: ["Research and follow-up", "Approval alerts", "Plain-English status updates"],
  },
  {
    name: "Momentum Desk",
    price: "KES 6,500",
    meta: "Full operating floor",
    detail: "More workers, AI actions, channels, reports, and approvals",
    href: "/auth/signup?plan=operator",
    featured: true,
    lines: ["Core launch providers", "Optional expansion", "Advanced workflow logic"],
  },
  {
    name: "Command Floor",
    price: "KES 16,900",
    meta: "Team-scale operations",
    detail: "High-volume voice, messages, AI actions, boardroom, and seats",
    href: "/auth/signup?plan=command",
    featured: false,
    lines: ["Multi-department ops", "Boardroom visibility", "Team collaboration"],
  },
] as const;
