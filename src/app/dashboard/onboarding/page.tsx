...
export default async function OnboardingPage() {
  ...
  const steps: OnboardingStep[] = [
    ...
    },
    {
      ...
      copy: "Describe a job in plain language: inbound leads, bookkeeping, market watch. Dobly proposes the coworker, the tools they need, and the rules they will work under.",
