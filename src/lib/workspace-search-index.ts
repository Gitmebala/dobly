...
export const WORKSPACE_SEARCH_INDEX: WorkspaceSearchItem[] = [
  ...
  { id: "brain", label: "Brain view", description: "Everything connected: coworkers, loops, and groups as a graph", category: "Go to", href: "/dashboard/brain", keywords: "brain view graph map connections everything obsidian", icon: Brain },
