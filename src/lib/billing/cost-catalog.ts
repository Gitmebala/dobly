...
export const COST_ROUTES: CostRoute[] = [
  ...
  { id: "research-tavily", capability: "research.deep", provider: "tavily", market: "GLOBAL", estimatedMinor: 0, unit: "task", paidRail: false, quality: "standard", note: "Free-tier AI search API for deep, cited web research." },
